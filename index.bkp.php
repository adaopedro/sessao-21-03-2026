...
$prod1Total = calcularTotalProduto($prod1Preco, $prod1Qtde);
$prod2Total = calcularTotalProduto($prod2Preco, $prod2Qtde);
$prod3Total = calcularTotalProduto($prod3Preco, $prod3Qtde);

mostrarTotalProdutoFormatado($prod1Total);
mostrarTotalProdutoFormatado($prod2Total);
mostrarTotalProdutoFormatado($prod3Total);
...
$nomeAluno = "Nzuzi Alberto";

$numeroCaracteres = strlen($nomeAluno);
// echo $nomeAluno;
echo strtoupper($nomeAluno);
...
$produtos = [
    ...
    [
        "id" => 9726,
        "nome" => "Notebook HP celeron 8GB RAM",
        "preco_unitario" => 180000
    ],
    [
        "id" => 9756,
        "nome" => "Mouse gamer HP sem fio",
...
foreach ($produtos as $produto) {
    ...
    echo "<br>Nome do produto: " . $produto["nome"];
    echo "<br>----------------------";
}